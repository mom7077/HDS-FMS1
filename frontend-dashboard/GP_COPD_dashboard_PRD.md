...
### 5.4 我的健康摘要
- 三个趋势图横向排布：Achievement %、Average Intervention Coverage、Average Annual COPD Review。
- 趋势取当前过滤条件下排名靠前的诊所，实时随 postcode/筛选条件更新。
- 卡片显示 Top Practice 要点（名称、成就率、登记人数等）。
- 下方仍保留关键指标的平均值，随着趋势数据同步变化。
